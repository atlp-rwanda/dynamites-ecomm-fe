...
const mockProduct3: Product = {
  ...
  averageRating: 3.5,
  createdAt: '2024-01-01T00:00:00.000Z',
  updatedAt: '2024-01-03T00:00:00.000Z', // Different from created date for sorting test
  category: mockCategory,
  vendor: mockVendor,
};
...
describe('MostRecent Component', () => {
  ...
  it('renders the MostRecent component with products sorted by updatedAt', async () => {
    render(
    ...
    const titleElement = screen.getByText('Recent Products');
