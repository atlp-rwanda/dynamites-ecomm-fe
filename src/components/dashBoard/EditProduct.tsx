    ...
    <div className="pr-[3%]">
        ...
        <div className="bg-white mr-[10%] w-full h-full flex flex-col pr-[5%] pt-[5%] pb-[10%] rounded-2xl">
            <div className=" grid gap-[5%] md:grid-cols-2 grid-rows-1 mb-[3%] sm:grid-cols-1 ">
                <div className="flex flex-col justify-start items-center text-[#3E3E3E] text-[14px] pl-[7%]">
                    <div className=" w-full mx-[7%] mb-[2.5%] ">
                        <label htmlFor="Product Title" className=''>Product Name</label>
                        <div className="bg-[#F5F6F6] min-h-[51px] w-full flex flex-row mt-[10px] items-center pl-[10px] rounded-lg">
                            <input type="text" placeholder='Iphone' className=" w-full h-full outline-none  bg-[#F5F6F6]" />
                        </div>
                    </div>
                    <div className="w-full mx-[7%] mb-[2.5%]">
                        <label htmlFor="" className=''>Image</label>
                        <div className="bg-[#F5F6F6] min-h-[51px] w-full flex flex-row mt-[10px] items-center pl-[10px] rounded-lg">
                            <input type="file" className='w-full h-full outline-none  bg-[#F5F6F6]' />
                        </div>
                    </div>
                    <div className="w-full mx-[7%] mb-[2.5%]">
                        <label htmlFor="Product Title" className=''>Short Description</label>
                        <div className="bg-[#F5F6F6] min-h-[51px] w-full flex flex-row mt-[10px] items-center pl-[10px] rounded-lg">
                            <input type="text" placeholder='Short Description' className=" w-full h-full outline-none  bg-[#F5F6F6]" />
                        </div>
                    </div>
                    <div className="w-full mx-[7%] mb-[2.5%]">
                        <label htmlFor="Product Title" className=''>Long Description</label>
                        <div className="bg-[#F5F6F6] min-h-[51px] w-full flex flex-row mt-[10px] items-center pl-[10px] rounded-lg">
                            <input type="text" placeholder='Long Description' className=" w-full h-full outline-none  bg-[#F5F6F6]" />
                        </div>
                    </div>
                    <div className="w-full mx-[7%] mb-[2.5%]">
                        <label htmlFor="Product Title" className=''>Quantity</label>
                        <div className="bg-[#F5F6F6] min-h-[51px] w-full flex flex-row mt-[10px] items-center pl-[10px] rounded-lg">
                            <input type="text" placeholder='30' className=" w-full h-full outline-none  bg-[#F5F6F6]" />
                        </div>
                    </div>
                    <div className="w-full mx-[7%] mb-[2.5%]">
                        <label htmlFor="Product Title" className=''>Regular Price</label>
                        <div className="bg-[#F5F6F6] min-h-[51px] w-full flex flex-row mt-[10px] items-center pl-[10px] rounded-lg">
                            <input type="text" placeholder='$2000' className=" w-full h-full outline-none  bg-[#F5F6F6]" />
                        </div>
                    </div>
                </div>
                <div className='flex flex-col justify-start items-center text-[#3E3E3E] text-[14px] pl-[3%] sm:pl-[7%]'>
                    <div className="w-full mx-[7%] mb-[2.5%]">
                        <label htmlFor="Product Title" className=''>Type</label>
                        <div className="bg-[#F5F6F6] min-h-[51px] w-full flex flex-row mt-[10px] items-center pl-[10px] rounded-lg">
                    ...
                    <div className="w-full mx-[7%] mb-[2.5%]">
                        <label htmlFor="" className=''>Gallery</label>
                        <div className="bg-[#F5F6F6] min-h-[142px] w-full flex flex-row mt-[10px] items-center pl-[10px] rounded-lg">
                            <div className=" w-full h-full flex flex-col">
                                ...
                                <label htmlFor="gallery_" className=' flex flex-col justify-center items-center'><MdOutlineCloudUpload className=' w-[32px] h-[32px] text-primary'/><div className=" text-lg">Click To upload</div></label>
                            </div>
                        </div>
                    </div>
                    <div className="w-full mx-[7%] mb-[2.5%]">
                    <label htmlFor="Product Title" className=''>Category</label>
                        <div className="bg-[#F5F6F6] min-h-[51px] w-full flex flex-row mt-[10px] items-center pl-[10px] rounded-lg">
                            <select  className=" w-full h-full outline-none  bg-[#F5F6F6]" >
                    ...
                    <div className="w-full mx-[7%] mb-[2.5%]">
                        <label htmlFor="Product Title" className=''>Gallery</label>
                        <div className="bg-[#F5F6F6] min-h-[51px] w-full flex flex-row mt-[10px] items-center pl-[10px] rounded-lg">
                            <input type="text" placeholder='$2000' className=" w-full h-full outline-none  bg-[#F5F6F6]" />
                        </div>
                    </div>
                    <div className="w-full mx-[7%] mb-[2.5%]">
                        <label htmlFor="Product Title" className=''>Is Available</label>
                        <div className="bg-[#F5F6F6] min-h-[51px] w-full flex flex-row mt-[10px] items-center pl-[10px] rounded-lg">
                            <select  className=" w-full h-full outline-none  bg-[#F5F6F6]" >
            ...
            <div className="flex flex-row items-center justify-between self-center">
                <button className=" bg-primary border-[2px] h-full w-full border-primary text-white px-[60px] py-[7px] rounded-md flex justify-center items-center gap-2 text-lg
