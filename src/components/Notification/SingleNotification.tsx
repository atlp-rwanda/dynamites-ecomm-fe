    ...
    <div className=' bg-white flex flex-row items-center justify-between py-[2%] rounded-xl px-[2%] border border-primary hover:shadow-md hover:shadow-primary' >
      <div className=" flex flex-row gap-x-[5%]">
          ...
          <div className=" flex flex-col">
            ...
            <div className=" pb-[10px] text-dashgreytext">{notification.message_title}</div>
            <div className=" max-w-[40vw] truncate">{notification.message_content}</div>
      ...
      <div className=" flex flex-col">
          <div className=" flex flex-row items-center justify-between px-[0.7vw] pb-[2vh]">
            <div onClick={() => makeAsRead()} className="h-[36px] w-[36px] rounded-full flex items-center justify-center hover:border-primary hover:border">
              <MdOutlineMarkChatRead className={` ${notification.isRead ? 'text-black':'text-primary'} w-[20px] h-[20px]`}/>
            </div>
            <div onClick={()=> handleDelete()} className="h-[36px] w-[36px] rounded-full flex items-center justify-center hover:border-primary hover:border">
