...
function Notification() {
  ...
  const [clickedNotification, setclicked] = useState<NotificationBox | null>(
    null
  );
  ...
  const handleopen = (notification: NotificationBox) => {
    ...
    setmessagecontent(
      convertNewlinesToBr(clickedNotification?.message_content || '')
    );
    setfocused(true);
  };
        ...
        <div className=" bg-white flex flex-col justify-center items-start mx-[5%] px-[2%] rounded-xl mt-[3%]">
          {paginatedData.map((notification) => (
            <div
              ...
              onDoubleClick={() => handleopen(notification)}
            ...
            <div className="">
              <div className=" flex flex-row">
                ...
                <div className=" underline underline-offset-[8px]">
                  {clickedNotification?.message_title}
                </div>
              </div>
              <div className=" flex flex-row">
                <div
