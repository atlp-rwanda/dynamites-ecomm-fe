        ...
        <tbody className="">
          {status === 'loading' &&
            Array(8)
              ...
              .map((_, index) => (
                <tr
                  key={index}
                  className="border-b-[2.5px] min-w-full h-[60px]  border-morelightgrey last:border-none"
                >
                  <td key="ID" className="">
          ...
          {status === 'succeeded' &&
            paginatedData.map((product, index) => (
              <tr
                key={index}
                className="text-grey leading-[16px] text-[12px] font-normal border-b-[2px] border-morelightgrey last:border-none hover:translate-x-[0.7px] hover:border hover:bg-morelightgrey"
              >
